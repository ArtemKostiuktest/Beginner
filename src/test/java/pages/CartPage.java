...
public class CartPage extends BasePage {
    ...
    protected final String PRICE_SHOES_FIELD_CART = "//div[@class='item-detail-total item-detail-total-js small-6 medium-3 large-1 columns ']";
    protected final String SIZE_SHOES_FIELD_CART = "//dd[contains(text(),'2.5')]";
